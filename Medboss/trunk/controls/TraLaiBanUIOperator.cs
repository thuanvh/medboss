...
namespace Nammedia.Medboss.controls
{
    ...
    public class TraLaiBanUIOperator : OperatorBase
    {
        ...
        private TraLaiBanUI traLaiUI;
        private TextBox txtMaHoaDon;

        public TraLaiBanUIOperator(bool thuHayChi)
        {
        ...
        public TraLaiBanUIOperator(int MaHoaDon)
        {
            this.components = null;
            this.InitializeComponent();
            HoaDonTraLaiInfo hdtralaiInfo = new HoaDonTraLaiBanController().GetById(MaHoaDon);
        ...
        private void butTaiHoaDon_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.txtMaHoaDon.Text != "")
                {
                    ...
                    HoaDonTraLaiInfo hdtralaiInfo = new HoaDonTraLaiBanController().GetById(id);
        ...
        {
            this.dataid = new HoaDonTraLaiBanController().Delete(this.traLaiUI.getHoaDonTraLai().MaHoaDon);
            return this.dataid;
        }
        ...
        {
            this.dataid = new HoaDonTraLaiBanController().Insert(this.traLaiUI.getHoaDonTraLai());
            return this.dataid;
        }
        ...
        {
            this.dataid = new HoaDonTraLaiBanController().Update(this.traLaiUI.getHoaDonTraLai());
            return this.dataid;
        }
