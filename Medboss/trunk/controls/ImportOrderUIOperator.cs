...
namespace Nammedia.Medboss.controls
{
    ...
    public class ImportOrderUIOperator : OperatorBase
    {
        ...
        private ImportOrderUI thongTinNhapThuoc;
        ...
        public ImportOrderUIOperator(int maHoaDon)
        {
            this.components = null;
            this.InitializeComponent();
            this.MaHoaDon = maHoaDon;
            HoaDonNhapThuocInfo hdnInfo = new HoaDonNhapThuocController().GetById(maHoaDon);
            if (hdnInfo != null)
            {
                this.LoadHD(hdnInfo);
            }
        ...
        private void butTaiHoaDon_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.txtMaHoaDon.Text != "")
                {
                    ...
                    HoaDonNhapThuocInfo hdnInfo = new HoaDonNhapThuocController().GetById(id);
                    if (hdnInfo != null)
                    {
                        this.LoadHD(hdnInfo);
                        this.MaHoaDon = id;
        ...
        {
            HoaDonNhapThuocController controller = new HoaDonNhapThuocController();
            return (this.dataid = controller.Delete(this.thongTinNhapThuoc.getHoaDonNhapThuoc().MaHoaDon));
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.thongTinNhapThuoc = new ImportOrderUI();
            ...
            base.SuspendLayout();
            this.butNhap.Location = new Point(0x125, 13);
            ...
            this.groupBox1.Size = new Size(0x11e, 0x4b);
            ...
            this.butXoa.Location = new Point(0x1c7, 13);
            ...
            this.butSua.Location = new Point(0x176, 13);
            ...
            base.Name = "ImportOrderUIOperator";
        ...
        {
            HoaDonNhapThuocController controller = new HoaDonNhapThuocController();
            return (this.dataid = controller.Insert(this.thongTinNhapThuoc.getHoaDonNhapThuoc()));
        }

        private void LoadHD(HoaDonNhapThuocInfo hdnInfo)
        {
        ...
        {
            HoaDonNhapThuocController controller = new HoaDonNhapThuocController();
            return (this.dataid = controller.Update(this.thongTinNhapThuoc.getHoaDonNhapThuoc()));
        }
