namespace Nammedia.Medboss.controls
{
    ...
    public class TraLaiBanUI : MedUIBase
    {
        ...
        public TraLaiBanUI(int MaHoaDon)
        {
            this.IsTinhThanhTien = false;
            this.IsLoading = false;
            this.components = null;
            this._orTraLai = new HoaDonTraLaiInfo();
            this.InitializeComponent();
            this._orTraLai = new HoaDonTraLaiBanController().GetById(MaHoaDon);
        ...
        private void dgrBanThuocChiTiet_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if ((e.ColumnIndex == this.colThanhTien.Index) && !this.IsTinhThanhTien)
            {
                this.updateDonGia(row);
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.colHanSuDung.DefaultCellStyle = dataGridViewCellStyle7;
        ...
        public void loadInfo(HoaDonTraLaiInfo hoaDonTraLai)
        {
            ...
            if ((this._orTraLai.Ngay < this.cboNgay.MaxDate) && (this._orTraLai.Ngay > this.cboNgay.MinDate))
            {
        ...
        public void setThuHayChi(bool thuHayChi)
        {
            ...
            this.lblTitle.Text = "Nhận lại thuốc trả lại của kh\x00e1ch h\x00e0ng.";
        }
