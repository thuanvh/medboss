namespace Nammedia.Medboss.Autocomplete
{
    ...
    internal class DataGridViewComboBoxColumnAutocompleter : AutoCompleter
    {
        private DataGridViewComboBoxColumn _col;
        ...
        private void DataGridView_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            if (view.CurrentCell.ColumnIndex == this._col.Index)
            {
                if (_enable)
                {
                    completer = new ComboBoxAutocompleter();
        ...
        {
            this._col = (DataGridViewComboBoxColumn) column;
